...
function copiarCorreo() {
  const correo = emailActual || document.getElementById("correoGenerado")?.textContent.trim();
...
async function iniciar() {
  try {
    ...
    // Solo copiar si ya está generado correctamente
    if (emailActual.includes('@')) copiarAlPortapapeles(emailActual);
